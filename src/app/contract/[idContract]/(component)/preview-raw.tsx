   ...
   return (
      <div>
         <ScrollArea className='h-[772px] w-[100%] rounded-md border'>
            <form className='w-[100%] max-w-[100%] border p-16 text-sm shadow-2xl'>
               <div id='main'>
                  <div id='application'>
                           ...
                           >
                              ...
                              {contractAttribute.date && (
                                 <span>
                                    {extractDatePart(
                                       convertToDateVN(
                                          contractAttribute.date.toString()
                                       ),
                                       'day'
                                    )}
                                 </span>
                        ...
                        <div className='wrapper-content'>
                           <div className='contentA my-3'>
                              <div className='font-bold'>
                                 BÊN NHÀ CUNG CẤP ( sau đây gọi tắt là Nhà cung
                                 cấp ):
                              </div>
                              <div className='information-A'>
                                 <div className='items-cente mt-2 flex'>
                                    <span
                                       ref={previewRefs.PreviewSupplierNameRef}
                                    >
                                       - Tên doanh nghiệp:&nbsp;
                                    </span>
                                 ...
                                 <div className='mt-2 flex items-center justify-between'>
                                    ...
                                    <span
                                       ref={previewRefs.PreviewSupplierFaxRef}
                                    >
                                       {' '}
                                       Fax:&nbsp;{' '}
                                       {contractAttribute.supplierFax}
                                    </span>
                                 </div>
                                 <div className='mt-2 flex items-center justify-between'>
                                    <span
                           ...
                           <div className='contentB my-3'>
                              ...
                              <div className='information-A'>
                                 <div className='mt-2 text-wrap'>
                                    <span
                                       ref={previewRefs.PreviewCustomerNameRef}
                                    >
                                       - Tên doanh nghiệp:&nbsp;
                           ...
                           <div className='my-2'>
                              <span ref={previewRefs.PreviewSigningDateRef}>
                                 Thỏa thuận cung cấp này Thỏa thuận được ký kết
                                 vào ngày&nbsp;
