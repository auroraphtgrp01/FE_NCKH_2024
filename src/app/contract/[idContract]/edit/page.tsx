...
export default function DialogEditContract() {
  ...
  const [propertiesCBX, setPropertiesCBX] = useState<string[]>(["property1"]);
                        ...
                        <div className="">
                            ...
                            <div className="">
                              ...
                              <div className="flex items-center">
                                ...
                                <Input
                                  ...
                                  className="mt-2 ml-2 "
                                  onBlur={(e) => {
                                    handleChangInput("supplierSurrogate", e);
                                    handleInputChangePosition(
                                      "supplierSurrogate",
                                      e,
                              ...
                              <div className="flex items-center">
                                ...
                                <Input
                                  ...
                                  onBlur={(e) => {
                                    handleChangInput("supplierPhoneNumber", e);
                                    handleInputChangePosition(
                                      "supplierPhoneNumber",
                                      e,
                                  ...
                                  ref={inputRefs.supplierPhoneNumber}
                                ></Input>
                              ...
                              <div className="flex items-center">
                                ...
                                <Input
                                  ...
                                  ref={inputRefs.supplierAccountNumber}
                                ></Input>
                                <span className="text-nowrap pt-2">
                                  {" "}
                                  tại Kho bạc:
                            ...
                            <div className="">
                              ...
                              <div className="flex items-center">
                                ...
                                <Input
                                  ...
                                  className="mt-2 ml-2 "
                                  onBlur={(e) => {
                                    handleChangInput("customerCitizenID", e);
                                    handleInputChangePosition(
                                      "customerCitizenID",
                                      e,
                              ...
                              <div className="flex items-center">
                                ...
                                <Input
                                  ...
                                  className="mt-2 ml-2 "
                                  onBlur={(e) => {
                                    handleChangInput("customerSurrogate", e);
                                    handleInputChangePosition(
                                      "customerSurrogate",
                                      e,
                              ...
                              <div className="flex items-center">
                                ...
                                <Input
                                  ...
                                  className="mr-2 mt-2 ml-2 "
                                  onBlur={(e) => {
                                    handleChangInput("customerPhoneNumber", e);
                                    handleInputChangePosition(
                                      "customerPhoneNumber",
                                      e,
                                  ...
                                  ref={inputRefs.customerPhoneNumber}
                                ></Input>
                                <span className="text-nowrap pt-2">
                                  {" "}
                                  Số tài khoản
                                ...
                                <Input
                                  ...
                                  ref={inputRefs.customerAccountNumber}
                                ></Input>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center my-2">
                            <div className="text-nowrap">
                              {" "}
                              Hai bên thống nhất ký kết hợp đồng với các nội
                              dung sau đây:
                            </div>
                          </div>
                        </div>
                        <div className="mt-3">
                          ...
                          <div className="grid grid-cols-2 text-center mt-5">
                            <div className="mr-10">
                              ...
                              <span ref={inputRefs.supplierSignature}>
                                {" "}
                                <Textarea
                                  ...
                                  className=" h-[130px]"
                                  onBlur={(e) => {
                                    handleChangInput("supplierSignature", e),
                                      handleInputChangePosition(
                                        "supplierSignature",
                                        e,
                            ...
                            <div className="">
                              ...
                              <span ref={inputRefs.customerSignature}>
                                {" "}
                                <Textarea
                                  placeholder="Ký, ghi rõ họ tên"
                                  name=""
                                  ...
                                  className=" h-[130px]"
                                  onBlur={async (e) => {
                                    handleChangInput("customerSignature", e),
                                      handleInputChangePosition(
                                        "customerSignature",
                                        e,
