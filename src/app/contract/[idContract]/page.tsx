                     ...
                     <CardContent className='text-sm'>
                        <div className='grid gap-3'>
                           <div className='font-semibold'>
                              Name of Contract:{' '}
                              <span>{contractData?.contractTitle}</span>
                           </div>
                           <div className='font-semibold'>
                              Created By:{' '}
                              <span>{contractData?.createdBy?.name}</span>
                           </div>
                           <div className='font-semibold'>
                              Address Contract:
                              <Input
                     ...
                     <CardContent className='text-sm'>
                           ...
                           {isVisibleButton.transferButton && (
                              <Button
                                 ...
                                 onClick={() => {
                                    setIsOpenEnterPrivateKey(true);
                                    setNameFunctionCall(
                                       EFunctionCall.TRANSFER_CONTRACT
                                    );
                                    setPrivateKey('');
                                 }}
                              >
                           ...
                           {isVisibleButton.withdrawButton && (
                              <Button
                                 ...
                                 onClick={() => {
                                    setIsOpenEnterPrivateKey(true);
                                    setNameFunctionCall(
                                       EFunctionCall.WITHDRAW_CONTRACT
                                    );
                                    setPrivateKey('');
                                 }}
                              >
                        ...
                        <div className='flex gap-2'>
                           ...
                           {isVisibleButton.confirmButtonReceiver && (
                              <Button
                                 disabled={
                                    isDisableButton.confirmButtonReceiver
                                 }
                                 variant={'indigo'}
                                 className='mt-2 w-full'
                                 onClick={() => {
                           ...
                           <AlertDialog>
                              ...
                              <AlertDialogContent>
                                 <AlertDialogHeader>
                                    <AlertDialogTitle>
                                       Are you absolutely sure to create dispute
                                       contract?
                                    </AlertDialogTitle>
                                    <AlertDialogDescription>
                  ...
                  <AlertDialogContent>
                     ...
                     <AlertDialogDescription className='text-center'>
                        <b className='text-red-500'>
                           If you forget the private key, you will not be able
                           to recover it and will lose access to the contract
                        </b>
                     </AlertDialogDescription>
                     <Input
