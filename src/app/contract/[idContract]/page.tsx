...
export default function Page() {
  ...
  const addInput = () => {
    ...
    const clone = [
      ...values,
      { value: "Select framework...", label: "Select framework..." },
    ];
    setInputs(newInputs);
    setValues(clone);
  };
                                        ...
                                        <div className="">
                                          ...
                                          <div className="flex items-center">
                                            ...
                                            <Input
                                              ...
                                              onBlur={(e) => {
                                                handleChangeSupplierTreasury(e);
                                                handleInputChangePosition(
                                                  "supplierTreasury",
                                                  e,
