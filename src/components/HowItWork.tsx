   ...
   return (
      <section id='howItWorks' className='container py-24 text-center sm:py-32'>
         ...
         <p className='mx-auto mb-8 mt-4 text-xl text-muted-foreground md:w-3/4'>
            Smart contracts in our SCM have revolutionized efficiency and
            transparency! With every transaction seamlessly executed and
            recorded, our supply chain is now a model of trust and precision !
         </p>
