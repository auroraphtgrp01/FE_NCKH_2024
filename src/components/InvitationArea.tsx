...
export default function InvitationArea({ invitation, setInvitation, messages, setMessages, participant }: IInvitationArea) {
                                ...
                                <TableRow key={inv.email}>
                                    ...
                                    <TableCell className="text-right">
                                        <div className="flex">
                                            ...
                                            <Button variant={"destructive"} className='w-[50%]'>Delete</Button>
                                        </div>
                                    </TableCell>
                                </TableRow>
                            ))}
